...
function App() {
  ...
  function calculate(event) {
    ...
    if (n1 !== "" && n2 !== "" && operator !== "") {
      ...
      setLastOperateScreen(n1,n2,operator);
      ...
      <form action="" onSubmit={calculate}>
        ...
        <section id="buttonsGrid">
          <article id="numbersGrid">
            ...
            <button type="button" title="Informe o radicando e depois a índice" className="operatorButton" onClick={() => addOperator('root')}> √ </button>
            <button type="button" title="Informe a base e depois o expoente" className="operatorButton" onClick={() => addOperator('^')}> ^ </button>
